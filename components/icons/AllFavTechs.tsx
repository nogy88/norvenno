...
const AllFavTechs: FunctionComponent = () => {
  return (
    <>
      <motion.p
      ...
      >
        ...
        <motion.li style={{ opacity: 1, transform: 'none' }} variants={animation}>
          <div className='transition duration-200 hover:text-[#0055FF]'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' role='img' fill='currentColor' className='h-6 w-6'><title>Framer Motion</title><path d='M4 0h16v8h-8zM4 8h8l8 8H4zM4 16h8v8z' />4
            </svg>
          </div>
        </motion.li>

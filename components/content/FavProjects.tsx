...
const Card = ({ image, title, category, appstore, link }: CardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-end gap-3'>
       ...
       {appstore!=="" &&  <ExternalLink href={appstore} customClassName='text-white inline-flex items-center rounded-lg bg-black p-2 hover:bg-gray-900 transition-all ease shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>

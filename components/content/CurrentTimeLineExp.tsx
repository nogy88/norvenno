  ...
  return (
    <Timeline>
      ...
      <TimelineEvent active>
        ...
        <TimelineEvent.Title><a href='https://www.ia.com.mx' target='_blank' rel='noopener noreferrer' className='hover:text-white hover:underline transition-all ease'>Tanasoft LLC (Zeely)</a> | oct. 2021 - Currently</TimelineEvent.Title>
